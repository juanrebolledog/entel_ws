...
<section>
    <header>
        <h3>
            <?= link_to(action('AdminBenefitCategoriesController@index'), 'Categorías de Beneficios'); ?> &raquo; Crear Nueva
        </h3>
    </header>
    <?= Form::model($category, array('url' => action('AdminBenefitCategoriesController@store'), 'files' => true)); ?>
        <fieldset>
