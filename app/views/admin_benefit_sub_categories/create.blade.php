...
<section>
    <header>
        <h3>
            <?= link_to(action('AdminBenefitSubCategoriesController@index'), 'Sub Categorías de Beneficios'); ?> &raquo; Crear Nueva
        </h3>
    </header>
    <?= Form::model($category, array('url' => action('AdminBenefitSubCategoriesController@store'), 'files' => true)); ?>
        <fieldset>
